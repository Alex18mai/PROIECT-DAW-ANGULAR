...
export class TodotaskEditService {
  ...
  editToDoTask(todotask: ToDoTask): void {
      console.log(todotask);
      const URL = `${this.todotasksURL}/update-todotask`;
      this.http.put(URL, todotask, { headers: this.headers }).subscribe(() => console.log("ToDoTask edited"));
  }
}
